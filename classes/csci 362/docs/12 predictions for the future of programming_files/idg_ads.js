...
IDG.ads = {
  networkID: "",
  slots: {
    topleaderboard: [[728,90],[950,98],[970,98]],
    ...
    overlayimu: [[336,280],[300,250],[300,1050],[300,600],[640,480]],
    dogear: [1,1],
    ticker: [[950,66],[950,55],[800,64],[800,30],[965,48],[970,66],[965,100],[970,30],[970,34],[970,55],[972,100],[970,250]],
  ...
  enable: function() {
    googletag.cmd.push(function() {
      googletag.pubads().setTargeting("URL", encodeURIComponent(window.location));
